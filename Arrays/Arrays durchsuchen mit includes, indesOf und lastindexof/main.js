...
console.log(personen.includes("Marcel", 1));    //true
...
console.log(personen.indexOf("Marcel", 1)); // 1 
...
console.log(personen.lastIndexOf("Marcel"));    //1
console.log(personen.lastIndexOf("Marcel", 3)); //1
